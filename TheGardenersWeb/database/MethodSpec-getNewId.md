...
Useful for a ticketing system. Once a number has been used, it is released back into the pool. Quickly read on a screen or paper ticket. Easily remembered. Easily spoken and heard via a loudspeaker, and thus can be quickly matched visually by the ticket holder.
...
The following is a pseudocode walk-through. (Note that this may be different from the actual code):
