...
public class Gateway {
	...
	public static void main( String[] args ) {
		...
		queryStringParameters = new HashMap<>( new HashMap<String, String>() { {
			put("ui_event", "INSERT_GARDEN");
			put("garden_name", "Janie's Garden");
			put("description", "A garden for little birds.");
		} } );
		event.setQueryStringParameters( queryStringParameters );
/*
		queryStringParameters = new HashMap<>( new HashMap<String, String>() { {
			put( "ui_event", "DELETE_GARDEN" );
			put( "garden_id", "1" );
		} } );
		event.setQueryStringParameters( queryStringParameters );
*/
