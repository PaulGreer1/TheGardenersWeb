...
public class Registrar {
	...
	/**
	 * @param eventHandler A reference to a lambda function. Attached to a UI option. Called by the notify() method when
	 *                     one of its events occurs.
	 * @param eventHandlerId ...
	 * @param event Occurrence of this event causes eventHandler to be invoked.
	 */
